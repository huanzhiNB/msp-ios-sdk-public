...
#ifndef PREBIDADAPTER_SWIFT_H
#define PREBIDADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PrebidAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface PrebidAdLoader (SWIFT_EXTENSION(PrebidAdapter)) <BannerEventHandler>
...
@interface PrebidAdLoader (SWIFT_EXTENSION(PrebidAdapter)) <BannerViewDelegate>
